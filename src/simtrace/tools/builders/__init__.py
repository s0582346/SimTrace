...
directly. Components start unwired — `simtrace.tools.simulation.connect` wires
them later.
...
This package re-exports every builder so `from simtrace.tools.builders import
...
from simtrace.tools.builders.edges import (
    create_buffer,
    create_conveyor,
    create_fleet,
)
from simtrace.tools.builders.nodes import (
    create_combiner,
    create_machine,
    create_sink,
    create_source,
